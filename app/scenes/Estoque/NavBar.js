...
const NavBarEstoque = () => {
  ...
  const { toggleFilterOpen } = React.useContext(EstoqueContext)
  ...
  return (
        <NavBarView style={styles.nav}>
            <View style={styles.navDivider}>
                ...
                <LabelPrimary style={styles.text}>ESTOQUE</LabelPrimary>
            </View>
            <View style={{ flexDirection: 'row' }}>
                <TouchableOpacity style={styles.buttonSync} onPress={toggleFilterOpen}>
