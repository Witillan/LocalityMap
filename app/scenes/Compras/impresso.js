...
const onSharing = async (tempId, empresa, userInfo) => {
  try {
    CompraDAO.GetOnePrint(tempId).then(async obj => {
      const qtdItem = obj.itens.length
      const html =
                `
                <!DOCTYPE html>
                <html lang="pt">
                <title>Compra Alpha-Vendas</title>
                <head>
                    <style type="text/css">
                        .logo {
                            display: flex;
                ...
                <body>
                    ...
                    <div class="div-data">
                        <div class="row">
                            <div>
                                ...
                                <div class="div">
                                    ...
                                    <div class="value">
                                        ${obj.fornecedor.apelido || obj.fornecedor.nomeRazao}
                                    </div>
                                </div>
                            </div>
                            <div>
                                ...
                                ${obj.numeroCompra ? `<div class="div">
                                    <strong class="text">
                                        N° Compra:
                                    </strong>
                                    <div class="value">
                        ...
                        <div class="div">
                            ...
                            <div class="value">
                                ${formatarCpfOuCnpj(obj.fornecedor.cpf)}
                            </div>
                        </div>
                        <div class="div">
                            <div class="text">
                            ...
                            <div class="value">
                                ${obj.fornecedor.endereco}${obj.fornecedor.numero ? ', n° ' + obj.fornecedor.numero : ' '}${obj.fornecedor.bairro ? ', ' + obj.fornecedor.bairro : ' '}${obj.fornecedor.complemento ? ', ' + obj.fornecedor.complemento : ' '}
                            </div>
                        </div>
                        <div class="div">
                            <div class="text">
                        ...
                        <table style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align:center">Acres. Unit</th>
                    ...
                    return `<tr>
                                            ...
                                            <td style="text-align:right">${NumberUtil.toDisplayNumberLeft(item.quantidade, '', true, casasDecimais)}</td>
                                            ...
                                            <td style="text-align:right">${NumberUtil.toDisplayNumberLeft(item.acrescimo, 'R$')}</td>
                                            <td style="text-align:right">${NumberUtil.toDisplayNumberLeft(item.descontoReal, 'R$')}</td>
                                            <td style="text-align:right">${NumberUtil.toDisplayNumberLeft(((item.valorUnitario * item.quantidade) - item.descontoReal) + item.acrescimo, 'R$')}</td>
                                    </tr>`
}).join('')}
                        </tbody>
                        </table>
                        ...
                        <div class="div">
                            <div class="column">
                                ...
                                <div class="row">
                                    ...
                                    <div class="value">
                                        ${NumberUtil.toDisplayNumberLeft(NumberUtil.mapSum(obj.itens.map(item => item.acrescimo)), 'R$')}
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="text">
                                ...
                                <div class="row">
                                    ...
                                    <div class="value">
                                        ${NumberUtil.toDisplayNumberLeft(obj.acrescimo, 'R$')}
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="text">
      ...
      const pdfName = `${filePath.uri.slice(0, filePath.uri.lastIndexOf('/') + 1)}Compra_${moment(obj.dataEHora).format('DD-MM-YYYY')}_${(obj.fornecedor.apelido || obj.fornecedor.nomeRazao).replace(/\s/g, '_')}.pdf`
