...
import { PedidoContext, SyncContext } from '../../components/navigation/contexts'
import { LabelPrimary, NavBarView, useDefaultStyleSheet } from '../../components/style'

const NavBarPedidos = () => {
  const { sync, loading } = React.useContext(SyncContext)
  const { toggleFilterOpen } = React.useContext(PedidoContext)
  ...
  return <NavBarView style={styles.nav}>
        <View style={styles.navDivider}>
            ...
            <LabelPrimary style={styles.text}>PEDIDOS</LabelPrimary>
        </View>
